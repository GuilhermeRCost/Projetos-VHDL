...
HD_PWD='C:/Users/AC Tecnologia/Documents/Projetos VHDL/Vivado 2017.4/Somador 3bits/Somador 3bits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log somador_3bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source somador_3bits.tcl -notrace
