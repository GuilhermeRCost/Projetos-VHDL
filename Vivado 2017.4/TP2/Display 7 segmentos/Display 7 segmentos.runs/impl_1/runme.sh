...
HD_PWD='C:/Users/AC Tecnologia/Documents/Projetos VHDL/Vivado 2017.4/TP2/Display 7 segmentos/Display 7 segmentos.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decodificador_7segmentos.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decodificador_7segmentos.tcl -notrace
