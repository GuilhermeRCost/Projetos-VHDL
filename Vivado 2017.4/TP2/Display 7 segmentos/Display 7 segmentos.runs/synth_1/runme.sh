...
HD_PWD='C:/Users/AC Tecnologia/Documents/Projetos VHDL/Vivado 2017.4/TP2/Display 7 segmentos/Display 7 segmentos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decodificador_7segmentos.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decodificador_7segmentos.tcl
