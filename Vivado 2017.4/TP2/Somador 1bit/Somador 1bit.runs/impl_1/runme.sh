...
HD_PWD='C:/Users/AC Tecnologia/Documents/Projetos VHDL/Vivado 2017.4/Somador 1bit/Somador 1bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log somador_1bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source somador_1bit.tcl -notrace
