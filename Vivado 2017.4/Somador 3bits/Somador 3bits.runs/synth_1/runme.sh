...
HD_PWD='C:/Users/AC Tecnologia/Documents/Projetos VHDL/Vivado 2017.4/Somador 3bits/Somador 3bits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log somador_3bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source somador_3bits.tcl
