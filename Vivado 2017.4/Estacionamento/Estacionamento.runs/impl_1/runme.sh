...
HD_PWD='C:/Users/AC Tecnologia/Documents/Projetos VHDL/Vivado 2017.4/Estacionamento/Estacionamento.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log quantidade_carros.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source quantidade_carros.tcl -notrace
