...
HD_PWD='C:/Users/AC Tecnologia/Documents/Projetos VHDL/Vivado 2017.4/Estacionamento/Estacionamento.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log quantidade_carros.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source quantidade_carros.tcl
