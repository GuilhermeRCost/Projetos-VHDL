...
HD_PWD='C:/Users/AC Tecnologia/Documents/Projetos VHDL/Vivado 2017.4/TestesClocks/TestesClocks.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Maquina_de_Estados.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Maquina_de_Estados.tcl
