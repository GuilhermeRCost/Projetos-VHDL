...
HD_PWD='C:/Users/AC Tecnologia/Documents/Projetos VHDL/Vivado 2017.4/TestesClocks/TestesClocks.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Maquina_de_Estados.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Maquina_de_Estados.tcl -notrace
