...
HD_PWD='C:/Users/AC Tecnologia/Documents/Projetos VHDL/Vivado 2017.4/TP4-2/TP4-2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Controlador_Farol.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Controlador_Farol.tcl -notrace
