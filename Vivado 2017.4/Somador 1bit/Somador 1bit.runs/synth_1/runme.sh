...
HD_PWD='C:/Users/AC Tecnologia/Documents/Projetos VHDL/Vivado 2017.4/Somador 1bit/Somador 1bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log somador_1bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source somador_1bit.tcl
